...
export const TruckIcon = component$(() => (
  <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16V6a1 1 0 00-1-1H4a1 1 0 00-1 1v10a1 1 0 001 1h1m8-1a1 1 0 01-1 1H9m4-1V8a1 1 0 011-1h2.586a1 1 0 01.707.293l3.414 3.414a1 1 0 01.293.707V16a1 1 0 01-1 1h-1m-6-1a1 1 0 001 1h1M5 17a2 2 0 004 0m-4 0a2 2 0 114 0m6 0a2 2 0 004 0m-4 0a2 2 0 114 0" />
  </svg>
));
...
export const AlertIcon = component$(() => (
  <svg class="w-14 h-14 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.856-.833-2.464 0L4.408 16.5c-.77.833.192 2.5 1.732 2.5z" />
  </svg>
));
...
// Export همه آیکون‌ها به صورت یک object
export const Icons = {
  Cart: CartIcon,
  Trash: TrashIcon,
  Plus: PlusIcon,
...
// نوع TypeScript برای autocomplete
